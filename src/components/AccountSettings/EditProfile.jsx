      ...
      <div className="w-[600px] flex flex-col gap-6 px-4">
            <div className="flex flex-col items-center sm:items-start sm:flex-row gap-4">
                ...
                <div className="flex flex-col items-center sm:items-start gap-4">
                    ...
                    <p className="italic opacity-80 text-sm">{userDescription}</p>

                    <button className="bg-ff-btn font-semibold rounded-lg py-2 px-3
            ...
            <form className="flex flex-col gap-8" onSubmit={handleSave}>
                <div className="flex flex-col sm:flex-row gap-4">
                    <input 
                        className="bg-transparent w-full border border-black rounded-2xl px-3 py-3 
                            placeholder:text-black placeholder:opacity-50 placeholder:italic" 
                        type="text"
                        placeholder="Nume"
                        value={firstName}
                ...
                <button
                    type="submit"
                    className={`bg-ff-btn text-black font-semibold rounded-lg py-2 px-4 mb-6 duration-150
