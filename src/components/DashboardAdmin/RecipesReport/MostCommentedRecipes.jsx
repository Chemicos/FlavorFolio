  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-row items-center">
        <h2 className="font-semibold text-xl">Most Commented Recipes</h2>
          ...
          <table className="min-w-full bg-ff-content rounded-t-lg">
            <thead>
              <tr>
                ...
                <th className="py-2 px-4 border-b border-l border-black border-opacity-20">Total Comments</th>
              </tr>
            </thead>
            <tbody>
              {mostCommentedRecipes.map((recipe, index) => (
                <tr key={index}>
                  ...
                  <td className="py-2 px-4 border-b text-center border-l border-black border-opacity-20">{recipe.commentsCount}</td>
                </tr>
              ))}
            </tbody>
          </table>
