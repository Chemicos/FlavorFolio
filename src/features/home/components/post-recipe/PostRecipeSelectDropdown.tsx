        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="absolute left-0 right-0 top-[calc(100%+8px)] z-50 overflow-hidden rounded-lg border border-white/10 bg-[#0b0b0c] p-1 shadow-[0_18px_45px_rgba(0,0,0,0.45)]"
                >
                    {options.map((option) => {
