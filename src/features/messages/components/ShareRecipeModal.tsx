            ...
            {isOpen && (
                ...
                >
                    ...
                    <div>
                        ...
                        Send this {contentType} to someone
                        you mutually follow.
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-lg text-[#8f97b1] transition hover:bg-white/[0.06] hover:text-white disabled:opacity-50"
                    ...
                    <div className="border-b border-white/10 px-5 py-4">
                        ...
                        <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-lg bg-white/10">
                            ...
                            <div className="flex h-full w-full items-center justify-center text-[#feaa2b]">
                                <MovieRoundedIcon />
                            </div>
                            )}
                        </div>
                        ...
                        <div className="min-w-0">
                            ...
                            <span className="rounded-full bg-[#feaa2b]/10 px-2 py-0.5 text-[0.65rem] font-bold uppercase tracking-wide text-[#ffd28a]">
                                {contentType}
                            </span>
                            </div>
                    ...
                    {isLoading ? (
                        ...
                        <p className="mt-1 text-xs text-[#8f97b1]">
                            You can share content only with
                            users who follow you back.
                        </p>
                        </div>
                    )}
                    </div>
