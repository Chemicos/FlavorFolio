  ...
  return (
    <div className="space-y-3">
      {recipes.map((recipe, index) => (
        <div key={recipe.recipeId} className="flex items-center gap-3 rounded-xl bg-white/[0.03] p-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs text-[#8f97b1]">by {recipe.authorUsername}</p>
          </div>
